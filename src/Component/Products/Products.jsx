...
export function Products() {
  ...
  : <>
  <div className=" w-3/4 mx-auto pt-28">
 <form onSubmit={formik.handleSubmit} action="" className="flex flex-col gap-2">
     <label htmlFor="search">Search</label>
     <input className=" w-full border border-black border-solid outline-none rounded-md py-2 px-3"
      type="text" name="search" id="search"
      placeholder="Search In Prouducts"
  ...
  <div className=" row flex flex-wrap w-3/4 gap-5 mx-auto pt-10 pb-10">
